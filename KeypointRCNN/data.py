...
def load_data(train_img_path, train_key_path):
    ...
    train_loader = DataLoader(trainset, batch_size=16, shuffle=True, num_workers=4, collate_fn=collate_fn)
    valid_loader = DataLoader(validset, batch_size=16, shuffle = False, num_workers = 4, collate_fn = collate_fn)
