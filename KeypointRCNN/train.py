...
def train_model(train_loader, val_loader, num_epochs = 30, device= 'cuda'):
    ...
    for epoch in range(1, num_epochs+1):
        ...
        if val_loss <= best_loss:   # update best loss
          best_loss = val_loss
          torch.save(model, '/home/bum/workspace/ASAP/KeypointRCNN/models'+str(epoch)+'_'+str(best_loss)+'.pt')
...
def main():
    ...
    train_img_path = '/home/bum/workspace/ASAP/pigs/pig_train image'
    train_key_path = '/home/bum/workspace/ASAP/KeypointRCNN/pigs_keypoints2.csv'
